...
class HomeFaceRecognizedView extends StatefulWidget {
  final CameraDescription cameraDescription;

  const HomeFaceRecognizedView({
    Key? key,
    required this.cameraDescription,
  }) : super(key: key);

  @override
  HomeFaceRecognizedViewState createState() => HomeFaceRecognizedViewState();
}

class HomeFaceRecognizedViewState extends State<HomeFaceRecognizedView> {
